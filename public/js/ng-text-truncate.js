                ...
                if( $scope.useToggling ) {
                    var el = angular.element(    "<span>" + 
                                                    ...
                                                    "<span class='btn-link ngTruncateToggleText' " +
                                                        "ng-click='toggleShow()'" +
                                                        "ng-show='!open'>" +
                                                        " " + ($scope.customMoreLabel ? $scope.customMoreLabel : "<button class='btn btn-default btn-xs'><i class='glyphicon glyphicon-chevron-down'></i>&nbsp&nbspRead More</button> ") +
                                                    "</span>" +
                                                    "<span ng-show='open'>" + 
                                                        $scope.text.substring( threshould ) + 
                                                        "<span class='btn-link ngTruncateToggleText'" +
                                                              "ng-click='toggleShow()'>" +
                                                            " " + ($scope.customLessLabel ? $scope.customLessLabel : "<button class='btn btn-default btn-xs'><i class='glyphicon glyphicon-chevron-up'></i>&nbsp&nbspRead Less</button> ") +
                                                        "</span>" +
                                                    "</span>" +
                                                "</span>" );
                    $compile( el )( $scope );
