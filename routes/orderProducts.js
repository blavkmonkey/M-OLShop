...
router.route('/all/')
	...
	.post(function(req, res){
		var order = new Order();
            order.orderno = req.body
            order.orderdate = req.body
            order.username = req.body
            order.shippingaddr = req.body
            order.billingaddr = req.body
            order.shipping = req.body
            order.subtotal = req.body
            order.total = req.body
            order.status = req.body
            order.paymenttype = req.body
            order.creditcardno = req.body
